...
def process_datasets(input_dir, output_dir):
    ...
    for dataset_file in tqdm(dataset_files, desc="Processing datasets"):
        if dataset_file == "physical_exam.json":
            print(f"Skipping file: {dataset_file}")
            continue
        ...
        for data_entry in tqdm(dataset, desc=f"Processing {dataset_file}", leave=False):
            try:
                ...
                record = {
                    ...
                    "is_correct": model_answer == data_entry["answer_idx"],
                }
...
if __name__ == "__main__":
    DATA_DIR = "/home/ujinkang/Desktop/vscode/ubunut/medbullet_asfd"
    OUTPUT_DIR = "/home/ujinkang/Desktop/vscode/ubunut/res_medbullet/flash/ablation"
